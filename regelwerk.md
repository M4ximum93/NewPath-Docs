...
<!-- AUTO_UPDATED_START -->
<p class="np-last-updated">Zuletzt aktualisiert: 13.06.2026 17:55 Uhr</p>
<!-- AUTO_UPDATED_END -->
...
<section class="np-page-section np-rules-section">
  ...
  <article class="np-rule-block">
    ...
    <ol class="np-rule-list">
      ...
      <li class="np-rule-subitem"><strong>1.1.1.</strong> TEST: Diese Regel wurde neu hinzugefügt und dient nur zur Prüfung der automatischen Markierung.
